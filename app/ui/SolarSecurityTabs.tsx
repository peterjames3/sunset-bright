...
const contentData: ContentData = {
  "solar-full": {
    ...
    image:
      "/Solar panels on rooftops of small homes and businesses. A technician works on a panel.jpg",
  },
  "solar-hybrid": {
  ...
  "solar-grid": {
    ...
    benefits: [
      "Lower cost (no batteries)",
      "Uses grid as backup",
      "Net metering revenue",
    ],
    idealFor:
      "Properties with reliable grid access looking to reduce energy costs",
  ...
  "security-cctv": {
    ...
    idealFor:
      "Homes, businesses, and institutions requiring continuous surveillance",
    image:
      "/A high-resolution stock photo of a cluster of CCTV cameras dome, bullet, and PTZ with a blurred bokeh effect. The cameras, primarily white and black, are sharply in focus, creating a soft background and professional commerci.jpg",
  },
  "security-fence": {
    ...
    image: "/Alltech-Electric-Fence-Installation-Services-In-Kenya.webp",
  },
  "security-alarm": {
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`pb-2 px-4 label-text hover:cursor-pointer transition-all delay-300 ${
              activeTab === tab.id
                ? "border-b-1 border-tertiary font-bold"
