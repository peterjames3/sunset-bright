...
export default function About() {
  const carouselImages = [
    ...
    {
      src: "/commercial solar installation.jpeg",
      alt: "Solar farm installation",
    },
    {
      src: "/commercial installation2.jpeg",
    ...
    {
      src: "/A highly detailed 3D render of a solar-powered water pump system with a soft pastel color palette and eerie atmosphere. Green metal frame, black metallic pump. Two silver solar panels. Dry, dusty grou.webp",
      ...
      <div className="wrapper">
        <header className="flex flex-col gap-3">
          ...
          <h3 className="title  font-semibold bg-gradient-to-r from-background to-primary bg-clip-text text-transparent">
            Leading Solar Power Company in Kenya for Affordable and Reliable
            Solutions
          </h3>
        </header>
      </div>
        ...
        <div className="w-full md:w-2/5  flex flex-col items-center  justify-center ">
          <p className="text-background p-text">
            ...
            <span className="font-semibold text-primary">
              SunsetBright Energy Limited
            </span>
            , we specialize in providing professional and affordable solar panel
            installation and maintenance services across Kenya. Whether
            you&apos;re looking to power your home, business, or institution,
            our team ensures seamless and efficient installations tailored to
            your energy needs. With years of experience, we offer trusted
            maintenance services to keep your solar systems operating at peak
            performance. Our clients in Nairobi, Mombasa, and beyond trust us to
            deliver reliable and sustainable energy solutions.
          </p>
