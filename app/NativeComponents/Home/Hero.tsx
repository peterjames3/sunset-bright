...
const clientReviews = [
  {
    ...
    review:
      "The solar panel installation was seamless, and my electricity bill has dropped significantly. Highly recommend their service!",
  },
  {
    id: 2,
    name: "Tonny O",
    ...
    review:
      "Exceptional service! The team was professional and completed the installation ahead of schedule. Our business is now powered by clean energy!",
  },
  {
    id: 3,
    name: "Lucy W",
    ...
    review:
      "A game-changer for my business. The solar system is efficient, and the savings on energy costs are remarkable!",
  },
  {
    id: 4,
    name: "Mark R",
    ...
    review:
      "Reliable and efficient solar solutions. The team provided excellent support from consultation to installation!",
  },
  {
    id: 5,
    name: "Cathrina G",
    ...
    <div className=" relative w-full h-screen md:h-[55rem] flex items-center gap-10 bg-gradient-to-r from-gray-600 to-gray-900">
      ...
      <div className="absolute top-[50%] left-1/2 text-center pt-0 md:pt-28 md:text-start transition -translate-x-1/2 -translate-y-1/2  w-full sm:max-w-[600px] md:max-w-[840px] lg:max-w-[64rem] px-5 sm:px-0 text-background gap-3 ">
        <h1 className=" text-3xl sm:text-4xl lg:text-6xl pb-5 font-bold sm:pb-2">
          ...
          Your World with SunsetBright Energy Limited – Reliable Solar &
          Electrical Solutions.
        </h1>
        <p className=" mt-4 text-xl sm:text-2xl lg:text-3xl  pb-2">
          We specialize in solar and electrical solutions for residential and
          commercial clients, offering solar design, consultation, installation,
          and maintenance alongside electrical design, installation, power
          metering, CCTV, alarms, and electric fencing.
        </p>
