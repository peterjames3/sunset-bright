  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
        className="size-8 text-amber-900"
        stroke="currentColor"
      >
        <path
          d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"
    ...
    <section className="bg-background py-16 ">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="headline font-bold text-foreground">
                Smart Home Solutions: Power, Security & Efficiency for Every
                Need in Kenya
              </h2>
            </div>
          </div>
          <h3 className="font-semibold title bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">
            Discover the ideal home system for your needs—from reliable solar
            energy to advanced security modules. Upgrade your home with seamless
            automation, smart surveillance, and energy-efficient solutions.
          </h3>
        </header>
      </div>
      ...
      <div className=" wrapper grid md:grid-cols-2 lg:grid-cols-5 gap-3">
        {pricingTiers.map((tier, index) => (
          <div
            key={index}
            className=" rounded-lg shadow-lg overflow-hidden hover:cursor-pointer hover:shadow-xl  hover:scale-105 transition-transform duration-300 easeInOut"
          >
            ...
            <div className="p-6">
              ...
              <ul className="space-y-4 mb-6 h-full flex flex-col items-center justify-center md:justify-start md:items-start">
                {tier.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start gap-2">
                    ...
                    <span className="text-foreground label-text">
                      {feature}
                    </span>
                  </li>
                ))}
              ...
              <div className="mt-2">
                <a
                  ...
                  className="ml-2 rounded-md label-text w-full flex text-background  justify-center py-3 text-center items-center gap-2 bg-primary hover:cursor-pointer hover:bg-banner transition-all delay-300"
                >
                  {" "}
                  {/* <PhoneIncoming /> */}
                  +254 716 783432 2
