...
export default function BrandPatterns() {
  ...
  // Animation effect
  useEffect(() => {
    const currentScrollRef = scrollRef.current; // Store the current value
    ...
    return () => {
      if (observerRef.current && currentScrollRef) {
        observerRef.current.unobserve(currentScrollRef);
      }
    };
  }, []);
      ...
      <div className="wrapper px-4">
        <header className="mb-12 text-center">
          ...
          <p className="text-muted-foreground mt-4">
            We partner with industry-leading brands to deliver high-quality
            solar solutions
          </p>
        </header>
