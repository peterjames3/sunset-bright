    ...
    <div className="w-full py-8 bg-background">
      <div className="wrapper grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-14">
        <section className=" space-y-6">
          <h2 className="headline mb-4 font-bold text-foreground">
            Get in Touch
          </h2>
          <p className="text-textColor mb-6 font-medium text-[1.1rem]">
        ...
        <section>
          <header>
            <div className="flex items-start gap-2">
              ...
              <span className="text-textColor title">Send Us a Message</span>
            </div>
          </header>
        </section>
      </div>
